execute at @a align xz positioned ~ 0 ~ unless entity @e[tag=its_raining_marker,distance=..24] run summon minecraft:armor_stand ~ ~ ~ {Tags:["its_raining_marker","its_raining_marker_new"],Invisible:1b,Marker:1b}
